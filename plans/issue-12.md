# Plan for Issue #12: Planning mode and clarifying questions

- Status: open
- Labels: none
- Link: https://github.com/mistralai/mistral-vibe/issues/12

## Description
Great job guys! Works well and I love all the little design details you added. 

However, it would be great if there was a planning mode, like there is for Claude Code. It helps steer the model into the right direction and improve output quality.
