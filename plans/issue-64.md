# Plan for Issue #64: Model usage in Roo Code

- Status: open
- Labels: none
- Link: https://github.com/mistralai/mistral-vibe/issues/64

## Description
Not an issue of the VIBE CLI, but maybe one of the Mistral devs can give some input on https://github.com/RooCodeInc/Roo-Code/issues/9951 to add Devstral 2 to Roo Code, it seems that the vibe-cli is using the model differently compared to Roo Codes Mistral AI provider.
