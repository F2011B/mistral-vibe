# Plan for Issue #9: ollama/lmstudio support

- Status: open
- Labels: none
- Link: https://github.com/mistralai/mistral-vibe/issues/9

## Description
Mind adding documentation for how to use locally hosted models through something like ollama or lm studio? Would be great to be able to try it out with Mistral models offline
