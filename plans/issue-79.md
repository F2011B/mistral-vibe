# Plan for Issue #79: feature request: /init command

- Status: open
- Labels: none
- Link: https://github.com/mistralai/mistral-vibe/issues/79

## Description
Loving mistral vibe! Wondering, could a /init (or something like it) be added that creates an agent.md for us? Similar to a feature that already exists in claude code, opencode, etc.
