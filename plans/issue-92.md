# Plan for Issue #92: Support Image Input in Vibe Coding

- Status: open
- Labels: none
- Link: https://github.com/mistralai/mistral-vibe/issues/92

## Description
Agent CLIs such as Claude Code, Gemini CLI, and Codex already support image input for coding tasks (for example debugging screenshots, UI mockups, diagrams). It would be valuable for mistral-vibe "vibe coding" to support image input as well, to reach feature parity and unlock common workflows.
