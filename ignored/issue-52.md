# Plan for Issue #52: Feature Request: generate dependency graphs/map the codebase

- Status: open
- Labels: none
- Link: https://github.com/mistralai/mistral-vibe/issues/52

## Description
Dependency graph of objects can be used as a kind of map to the codebase and it could be useful for the assistant with large codebases, maybe?

Something like this, but for the assistant and not for the silly human:
https://youtu.be/ST1AmwUN6rw?t=47
